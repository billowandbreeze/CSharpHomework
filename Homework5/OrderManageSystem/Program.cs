    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            order1.ChangeDetails(orderDetails1, orderDetails3);
            Console.WriteLine(order1);

            order1.RemoveDetails(orderDetails2);
            Console.WriteLine(order1);
            */
            ...
            orderService.ChangeOrder(order1, order4);
            Console.WriteLine(orderService);
            ...
            orderService.FindOrderById("0001");
            orderService.FindOrderByClient(client2);
            orderService.FindOrderByPrize(6800);
            */
